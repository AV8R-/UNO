...
open class ComplexButton: UIControl {
    ...
    override open var contentVerticalAlignment: UIControl.ContentVerticalAlignment { didSet {
        self.nestedButtons.forEach { $0.contentVerticalAlignment = contentVerticalAlignment }
    }}
    
    override open var contentHorizontalAlignment: UIControl.ContentHorizontalAlignment{ didSet {
